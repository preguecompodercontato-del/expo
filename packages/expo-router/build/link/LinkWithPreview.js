...
function LinkMenuAction(props) {
    ...
    return (<native_1.NativeLinkPreviewAction {...rest} onSelected={onPress} keepPresented={dangerouslyKeepPresented}/>);
}
const LinkMenu = (props) => {
    if ((0, PreviewRouteContext_1.useIsPreview)() || process.env.EXPO_OS !== 'ios' || !(0, react_1.use)(InternalLinkPreviewContext)) {
        return null;
    }
    return <native_1.NativeLinkPreviewAction {...props} title={props.title ?? ''} onSelected={() => { }}/>;
};
